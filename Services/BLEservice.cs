...
//Github til det BLE plugin der anvendes https://github.com/dotnet-bluetooth-le/dotnet-bluetooth-le
//BLE og GATT viden https://devzone.nordicsemi.com/guides/short-range-guides/b/bluetooth-low-energy/posts/ble-characteristics-a-beginners-tutorial

//Not discovering devices: https://stackoverflow.com/questions/50509591/plugin-ble-for-xamarin-forms-not-detecting-devices
public class BLEservice
{
    public DeviceCandidate BleDevice { get; set; } //this is the device that we will connect to. It is used to read and write to the device.
    public List<DeviceCandidate> DeviceList { get; private set; } //List of found devices
    public IBluetoothLE bleInterface { get; private set; } //this is the bluetooth object interface that we will use to check for bluetooth availability and to ask for permission for bluetooth.
    public IAdapter AdapterInterface { get; private set; } // this is the adapter interface that we will use to scan for devices and to connect to devices.
    public IDevice DeviceInterface { get; set; } //this is the interface for the device that we will connect to. It is used to read and write to the device.
    ...
    { 
        ...
        try
        {
            ...
            BleDevice = new DeviceCandidate { Id = deviceId, Name = deviceName };
    ...
    private void Adapter_DeviceDiscovered(object sender, DeviceEventArgs e)
    {
        ...
        if (deviceCandidate == null)
        {
            ...
            DeviceCandidate foundDevice = new DeviceCandidate();
